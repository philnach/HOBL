...
## 2025.6.0 Release (3/16/2026)
* Update to Office 2602.  License keys no longer supported the prior version, so this became urgent.  Power impact has not been measured.
* Web_prep fixed to accommodate Edge UI change for clearing the cache.
