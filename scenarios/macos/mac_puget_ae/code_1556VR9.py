...
def run(scenario):
    ...
    benchmark_version = Params.get('mac_puget_ae', 'benchmark_version')
    # license_key = Params.get('mac_puget_ae', 'puget_license')
    loops = Params.get('mac_puget_ae', 'loops')
    ...
    output_file = scenario.dut_data_path + f'/after_effects_output.log'
