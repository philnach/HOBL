...
def run(scenario):
    ...
    benchmark_version = Params.get('mac_puget_pp', 'benchmark_version')
    app_version = Params.get('mac_puget_pp', 'app_version')
    # license_key = Params.get('mac_puget_pp', 'puget_license')
    loops = Params.get('mac_puget_pp', 'loops')
    ...
    output_file = scenario.dut_data_path + f'/premiere_pro_output.log'
