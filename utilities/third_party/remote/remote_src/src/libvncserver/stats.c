...
char *encodingName(uint32_t type, char *buf, int len) {
    ...
    case rfbEncodingQemuExtendedKeyEvent: snprintf(buf, len, "QemuExtKey");   break;
    case rfbEncodingQemuLedEvent:         snprintf(buf, len, "QemuLedEvent"); break;
    case rfbEncodingDesktopName:          snprintf(buf, len, "DesktopName");  break;
    case rfbEncodingFence:                snprintf(buf, len, "Fence");        break;
    case rfbEncodingContinuousUpdates:    snprintf(buf, len, "ContUpdates");  break;
    case rfbEncodingVMwareCursor:         snprintf(buf, len, "VMwareCursor"); break;
