...
.\hobl.cmd -p $ARGS[0] -s surface_app_prep global:attempts=2 global:run_type=Prep global:delay_between_runs=0
...
.\hobl.cmd -p $ARGS[0] -s config_check global:run_type=Misc global:attempts=2 global:post_run_delay=0
